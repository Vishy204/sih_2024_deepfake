...
function ResultPage() {
    ...
    return (
        <div>
            ...
            <p>Sync Score: {similarity ? similarity : 'No data available'}</p>
            <p>Lipnet Conclusion: {lip ? lip : 'No data available'}</p>
            <p>Freqnet Conclusion: {freq ? freq : 'No data available'}</p>
            <p>Microexpression Conclusion: {micro ? micro : 'No data available'}</p>
            <p>GazeTracker Conclusion: {gaze ? gaze : 'No data available'}</p>
            ...
            {mfcc1_64 && (
                <div>
                    <h2>MFCC Plot 1</h2>
                    <img src={`data:image/png;base64,${mfcc1_64}`} alt="MFCC Plot 1" style={{ maxWidth: '100%', height: 'auto' }} />
                </div>
            )}
            {mfcc2_64 && (
                <div>
                    <h2>MFCC Plot 2</h2>
                    <img src={`data:image/png;base64,${mfcc2_64}`} alt="MFCC Plot 2" style={{ maxWidth: '100%', height: 'auto' }} />
                </div>
            )}
            {mfcc3_64 && (
                <div>
                    <h2>MFCC Plot 3</h2>
                    <img src={`data:image/png;base64,${mfcc3_64}`} alt="MFCC Plot 3" style={{ maxWidth: '100%', height: 'auto' }} />
                </div>
            )}
            ...
            {image_base64 && (
                <div>
                    ...
                    <img src={`data:image/png;base64,${image_base64}`} alt="Eye Tracker Plot" style={{ maxWidth: '100%', height: 'auto' }} />
                </div>
            )}
