...
const About = () => {
  return (
    <div className="flex flex-col w-full h-full overflow-hidden about bg-[#0D0F15] text-white">
      {/* Navbar */}
      <Navbar />

      {/* Header Section */}
      <div className="flex flex-col items-center justify-center w-full pt-16 border-t-8  border-[#70B5ED] h-1/5 font-protest">
        <h1 className="text-[12vh]">About Us</h1>
      </div>

      {/* Summary Section */}
      <div className="flex flex-col items-center w-full py-10">
        <p className="text-[5vh] font-bold">Application Summary: User Focus Tracker</p>
        <p className="text-[3vh] mt-2 px-40 mb-[3vh] font-semibold">
        ...
        <h2 className="text-[4vh] font-bold">Key Features:</h2>
        <ul className="text-[3vh] mt-2 px-40 mb-[3vh] font-semibold list-disc">
        ...
        {/* Use Cases Section */}
        <h2 className="text-[4vh] font-bold">Use Cases:</h2>
        <ul className="text-[3vh] mt-2 px-40 mb-[3vh] font-semibold list-disc">
